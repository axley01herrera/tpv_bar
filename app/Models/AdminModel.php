...
class AdminModel extends Model
{
    ...
    public function getHistoryCancelProcessingData($params)
    {
        $query = $this->db->table('tpv_bar_table_history_cancel');
        ...
        $query->offset($params['start']);
        $query->limit($params['length']);
        $query->orderBy($this->getHistoryCancelProcessingSort($params['sortColumn'], $params['sortDir']));

        return $query->get()->getResult();
    }

    public function getHistoryCancelProcessingSort($column, $dir)
    {
        $sort = '';
